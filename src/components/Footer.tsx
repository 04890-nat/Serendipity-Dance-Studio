            ...
            <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
                ...
                <div>
                    ...
                    <div className="flex gap-2">
                        ...
                        <div className="w-10 h-10 rounded-full bg-[var(--surface-hover)] flex items-center justify-center hover:bg-[var(--primary-gold)] hover:text-black transition-all cursor-pointer">FB</div>
